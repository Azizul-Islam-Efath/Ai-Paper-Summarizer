...
const RecentPaperCard = ({ paper }) => {
  ...
  const statusMap = {
    ...
    SUMMARIZING: { label: 'Summarizing', color: '#a855f7', bg: 'rgba(168,85,247,0.12)', border: 'rgba(168,85,247,0.25)' },
    SUMMARIZED: { label: 'Summarized', color: '#a855f7', bg: 'rgba(168,85,247,0.12)', border: 'rgba(168,85,247,0.25)' },
    ERROR: { label: 'Failed', color: '#f87171', bg: 'rgba(248,113,113,0.12)', border: 'rgba(248,113,113,0.25)' },
  }
  const status = statusMap[paper.status] || statusMap.ERROR
